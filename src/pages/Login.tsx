  ...
  return (
    <div className="min-h-svh flex items-center justify-center bg-slate-50 px-4">
      <form
        ...
        className="w-full max-w-sm bg-white rounded-xl p-6 shadow-lg border border-slate-200"
      >
        <h1 className="text-xl font-semibold text-slate-900 mb-1">Portfolio Tracker IDX</h1>
        ...
        <input
          ...
          className="w-full mb-4 rounded-md bg-slate-100 border border-slate-300 px-3 py-2 text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
        ...
        {info && <p className="text-sm text-emerald-600 mb-4">{info}</p>}
